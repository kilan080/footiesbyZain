  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
      ...
      <Box
        sx={{
          ...
          "&::after": {
            ...
            inset: 0,
            background:
              "linear-gradient(to right, rgba(0,0,0,0.35), rgba(0,0,0,0.1))",
          },
        }}
      >
      ...
      >
        ...
        <Typography
          sx={{ fontSize: 28, fontWeight: 700, color: "#111", mb: 0.5 }}
        >
          Sign in
        </Typography>
        ...
        <Box component="form" onSubmit={handleSubmit} aria-label="login form">
          {/* Email */}
          <Typography
            sx={{ fontSize: 13, fontWeight: 600, color: "#333", mb: 0.8 }}
          >
            Email address
          </Typography>
          <TextField
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <EmailOutlined sx={{ color: "#bbb", fontSize: 20 }} />
                </InputAdornment>
              ),
            }}
            sx={inputSx}
        ...
        <Typography
          sx={{ textAlign: "center", fontSize: 13, color: "#888", mt: 1 }}
        >
          Are you an admin?{" "}
          <Link
            href="/admin-login"
