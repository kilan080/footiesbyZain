...
const FullScreenSlider: React.FC<ImageSliderProps> = ({
  images = ["/one.avif", "/two.avif", "/three.avif"],
  ...
  const slideContent = [
    {
      ...
      subtitle:
        "Experience the perfect blend of style and coziness with our exclusive collection.",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Perfect for work, play and everything in between, our versatile designs fit your lifestyle.",
    },
  ];
